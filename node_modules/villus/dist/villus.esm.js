/**
  ...
  * @license MIT
  */
import { isRef, isReactive, unref, getCurrentInstance, inject, provide, ref, watch, onMounted, computed, onBeforeUnmount } from 'vue';
...
function useQuery(opts) {
    ...
    function initVarWatchers() {
        ...
        watch(() => unwrap(variables), newValue => {
...
function useSubscription(opts, reduce = defaultReducer) {
    ...
    vm && onBeforeUnmount(() => observer === null || observer === void 0 ? void 0 : observer.unsubscribe());
    if (isWatchable(paused)) {
        watch(paused, val => {
            if (!val) {
                initObserver();
...
export { Client, CombinedError, VILLUS_CLIENT, cache, createClient, dedup, defaultPlugins, definePlugin, fetch, getActiveClient, getQueryKey, handleSubscriptions, makeFetchOptions, mergeFetchOpts, parseResponse, setActiveClient, useClient, useMutation, useQuery, useSubscription };
